...
export const runMongoPlatformSeed = async (): Promise<void> => {
  ...
  if (existingCheck.rowCount > 0) {
    console.log('[Seed] Facility data already exists — skipping seed.');
    return;
  }

  console.log('[Seed] Seeding facility reference data into MongoDB...');
  ...
  const departments = [
    // DGH Kapurthala
    { id: uid(), hospitalId: hospital1Id, name: 'General Medicine & OPD', headName: '', specialties: ['Fever', 'Diabetes Management', 'Hypertension', 'General Checkup'], beds: 60, opd: true, ipd: true, emergency: true, diagnostics: ['ECG', 'Blood Sugar'], createdAt: now, updatedAt: now },
    { id: uid(), hospitalId: hospital1Id, name: 'Obstetrics & Gynaecology', headName: '', specialties: ['Antenatal Care', 'Normal Delivery', 'High-Risk Pregnancy', 'Gynaecology OPD'], beds: 40, opd: true, ipd: true, emergency: true, diagnostics: ['Ultrasound', 'CTG'], createdAt: now, updatedAt: now },
    { id: uid(), hospitalId: hospital1Id, name: 'Paediatrics', headName: '', specialties: ['Newborn Care', 'Child Vaccination', 'Malnutrition Management', 'Neonatal ICU'], beds: 35, opd: true, ipd: true, emergency: true, diagnostics: ['Hemoglobin', 'Blood Culture'], createdAt: now, updatedAt: now },
    { id: uid(), hospitalId: hospital1Id, name: 'Surgery', headName: '', specialties: ['Emergency Surgery', 'Appendectomy', 'Hernia', 'Minor OPD Procedures'], beds: 45, opd: true, ipd: true, emergency: true, diagnostics: ['X-Ray', 'Ultrasound'], createdAt: now, updatedAt: now },
    { id: uid(), hospitalId: hospital1Id, name: 'Orthopaedics', headName: '', specialties: ['Fracture Management', 'Joint Pain', 'Road Accident Injuries'], beds: 30, opd: true, ipd: true, emergency: true, diagnostics: ['X-Ray'], createdAt: now, updatedAt: now },
    // Angara PHC
    { id: uid(), hospitalId: hospital2Id, name: 'General OPD', headName: '', specialties: ['Fever', 'Malaria', 'Diarrhoea', 'ANC', 'Immunization'], beds: 10, opd: true, ipd: false, emergency: true, diagnostics: ['RDT', 'Urine Dipstick'], createdAt: now, updatedAt: now },
    { id: uid(), hospitalId: hospital2Id, name: 'Maternal & Child Health', headName: '', specialties: ['Antenatal Care', 'Post-Natal Care', 'Child Nutrition', 'JSSY Delivery'], beds: 10, opd: true, ipd: true, emergency: false, diagnostics: ['Hemoglobin', 'Weight'], createdAt: now, updatedAt: now },
    // AIIMS Rishikesh
    { id: uid(), hospitalId: hospital3Id, name: 'Cardiology & CTVS', headName: '', specialties: ['Heart Failure', 'Coronary Artery Disease', 'Cardiac Surgery', 'Cath Lab'], beds: 80, opd: true, ipd: true, emergency: true, diagnostics: ['Echo', 'TMT', 'Cath Lab'], createdAt: now, updatedAt: now },
    { id: uid(), hospitalId: hospital3Id, name: 'Neurology & Neurosurgery', headName: '', specialties: ['Stroke', 'Epilepsy', 'Brain Tumour', 'Neuro ICU'], beds: 80, opd: true, ipd: true, emergency: true, diagnostics: ['MRI Brain', 'EEG', 'CT Head'], createdAt: now, updatedAt: now },
    { id: uid(), hospitalId: hospital3Id, name: 'Oncology', headName: '', specialties: ['Chemotherapy', 'Radiation Therapy', 'Cancer Screening', 'Palliative Care'], beds: 120, opd: true, ipd: true, emergency: false, diagnostics: ['PET Scan', 'Biopsy', 'Tumour Markers'], createdAt: now, updatedAt: now },
  ];
  ...
  console.log('[Seed] ✅ MongoDB facility reference data seed complete.');
