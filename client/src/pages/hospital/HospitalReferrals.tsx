    ...
    <div className="space-y-6 max-w-7xl mx-auto">
      ...
      <div className="bg-white dark:bg-slate-900 rounded-3xl border border-slate-200/80 dark:border-slate-800 p-5 sm:p-6 shadow-xs flex flex-wrap items-center justify-between gap-4">
        <div className="flex items-center space-x-3">
          ...
          <div>
            ...
            <p className="text-xs text-slate-500 dark:text-slate-400">
              Facility: <strong className="text-slate-800 dark:text-slate-200 font-semibold">Ranchi District Hospital & FRU</strong> • Inbound Referral Coordination
            </p>
          </div>
        </div>
        ...
        <button
          ...
          className="flex items-center space-x-1.5 px-3.5 py-2 rounded-xl bg-white dark:bg-slate-800 hover:bg-slate-50 dark:hover:bg-slate-700 text-slate-700 dark:text-slate-200 border border-slate-300 dark:border-slate-700 text-xs font-bold transition shadow-2xs"
        >
