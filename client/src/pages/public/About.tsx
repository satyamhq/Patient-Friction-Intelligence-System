...
export const About: React.FC = () => {
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 py-12 space-y-12">
      ...
      <div className="bg-teal-50/70 text-slate-900 rounded-3xl p-8 shadow-xs border border-teal-200/80 space-y-4 text-xs leading-relaxed">
        <div className="flex items-center gap-2">
          <ShieldCheck className="w-5 h-5 text-teal-600" />
          <h4 className="text-base font-bold text-teal-950">Strict Non-Clinical AI Governance Mandate</h4>
        </div>
